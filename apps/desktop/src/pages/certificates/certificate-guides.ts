...
export const windowsSteps: GuideStep[] = [
  { order: 1, description: "Press Win+R, type certlm.msc, and press Enter to open the Local Machine Certificate Manager." },
  { order: 2, description: "Navigate to Trusted Root Certification Authorities > Certificates in the left panel." },
  { order: 3, description: "Right-click on the Certificates folder, select All Tasks > Import." },
  { order: 4, description: "Click Next, then browse to the certificate file and select it." },
  { order: 5, description: "Ensure 'Place all certificates in the following store' shows 'Trusted Root Certification Authorities' and click Next." },
  { order: 6, description: "Click Finish. Accept the security warning about installing a root certificate." },
  { order: 7, description: "Restart your browser for the change to take effect." },
];
