...
const builtInFontCandidates: Record<BuiltInFontPreference, Record<FontLocale, readonly string[]>> = {
  system: {
    en: [
      "SF Pro Text",
      "SF Pro Display",
...
function getCustomFontCandidates(customFontFamily: string, fallbackPreference: BuiltInFontPreference, locale: FontLocale) {
...
function getCustomFontFamily(customFontFamily: string, fallbackPreference: BuiltInFontPreference, locale: FontLocale) {
