export const enMessages = {
  ...
  certificatesPage: {
    ...
    mobile: {
      ...
      adbInstallBody: "Connect one Android device over USB, enable USB debugging, then click the button. Pharles will push the root certificate into Downloads and open the system certificate installer on the device.",
      adbInstallHint: "This is not a silent install. You still need to confirm the certificate on the phone.",
      ...
      adbSuccessBody: "Certificate copied to {{remotePath}} on {{deviceSerial}}. Finish the install flow on your phone.",
      adbSuccessTitle: "ADB Installer Opened",
      android: "Android",
