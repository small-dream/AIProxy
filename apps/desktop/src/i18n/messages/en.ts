export const enMessages = {
  ...
  appShell: {
    ...
    windowsMenu: {
      adbClearProxy: "Clear Proxy via ADB",
      adbSetProxy: "Set Proxy via ADB",
      androidQuickActions: "Android Quick Actions",
      breakpointRules: "Breakpoint Rules...",
      ...
      documentation: "AIProxy Documentation",
      edit: "Edit",
      exportHar: "Export as HAR...",
      file: "File",
      find: "Find...",
      harmonyQuickActions: "HarmonyOS Quick Actions",
      help: "Help",
      importHar: "Import HAR...",
      installCert: "Install Root Certificate",
      iosQuickActions: "iOS Quick Actions",
  ...
  rulesPage: {
    ...
    unsavedChangesMessage: "The rule editor has unsaved changes. Leaving now will discard them.",
  ...
  sessionExplorer: {
    ...
    batchDelete: "Delete",
    batchExport: "Export",
    batchSaveResponses: "Save responses",
    batchSelected: "{{count}} selected",
    breakpointPending: "Paused by breakpoint",
    ...
    filterPlaceholder: "Search URL, method, status, MIME…",
    ...
    tooltipShortcuts: "↑/↓ navigate · ⌘/Ctrl+click multi-select",
    unknownHost: "<unknown>",
  ...
  websocket: {
    ...
    loadFailedTitle: "Failed to Load Messages",
    loadFailed: "The message history for this connection could not be loaded.",
    retry: "Retry",
