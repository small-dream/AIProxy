export const enMessages = {
  ...
  certificatesPage: {
    ...
    mobile: {
      ...
      adbInstallBody: "Connect one Android device over USB, enable USB debugging, then click the button. Pharles will push the root certificate into Downloads and open Android's certificate import entry on the device.",
      adbInstallHint: "Android may ask you to choose the file manually from Downloads. This is not a silent install, and you still need to confirm the certificate on the phone.",
      ...
      adbInstallTitle: "ADB Install for Developers",
      ...
      adbSuccessBody: "Certificate copied to {{remotePath}} on {{deviceSerial}}. If Android shows a file picker, choose this file from Downloads to finish the install.",
      adbSuccessTitle: "ADB Import Entry Opened",
      android: "Android",
