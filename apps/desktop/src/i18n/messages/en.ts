export const enMessages = {
  ...
  certificatesPage: {
    ...
    mobile: {
      ...
      adbInstallBody: "Connect one Android device over USB, enable USB debugging, then click the button. AIProxy will push the root certificate into Downloads and open Android's certificate import entry on the device.",
