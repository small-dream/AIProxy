...
export const zhCNMessages: Messages = {
  ...
  certificatesPage: {
    ...
    mobile: {
      ...
      adbInstallBody: "连接一台 Android 设备并开启 USB 调试后，点击按钮即可。AIProxy 会把根证书推送到设备的 Downloads 目录，并在设备上打开 Android 的证书导入入口。",
      adbInstallHint: "Android 可能会要求你手动从 Downloads 中选择该证书文件。这不是静默安装，你仍需要在手机上确认并完成安装。",
      adbInstalling: "正在通过 ADB 安装...",
      adbInstallRequirements: "要求本机 PATH 中可用 `adb`，并且你选择的目标设备处于“device”状态。",
      adbInstallTitle: "开发者 ADB 安装",
      ...
      adbSuccessBody: "证书已复制到 {{deviceSerial}} 的 {{remotePath}}。如果手机弹出文件选择器，请到 Downloads 中选择这个文件完成安装。",
      adbSuccessTitle: "已打开 ADB 导入入口",
      android: "Android",
