  ...
  certificatesPage: {
    ...
    mobile: {
      ...
      harmonySteps: [
        ...
        "点击上方的“通过 hdc 推送证书”会把根证书推送到设备，并尝试打开系统设置；这一步不会静默安装或信任证书。",
        "在设备上继续进入“设置 > 安全与隐私 > 加密与凭据 > 从存储设备安装”安装证书。如果系统文件选择器看不到 hdc 推送路径，请改用二维码/浏览器下载证书后再从下载位置安装。",
      ...
      hdcManualInstallSteps: [
        ...
        "点击“从存储设备安装”/“更多安全设置”，并选择证书文件；若看不到 hdc 推送文件，请用二维码或设备浏览器重新下载证书。",
      ...
      hdcSuccessBody:
        "证书已推送到设备 {{deviceSerial}} 的 {{remotePath}}，并已尝试打开系统设置。请继续进入“设置 > 安全与隐私 > 加密与凭据 > 从存储设备安装”完成安装；若看不到该文件，请改用二维码/浏览器下载证书。",
