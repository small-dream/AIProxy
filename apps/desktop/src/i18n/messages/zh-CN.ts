...
export const zhCNMessages: Messages = {
  ...
  settingsPage: {
    ...
    contentFontDescription: "内容 / 代码字体会作用于请求详情、响应体、JSON、Headers 等高密度技术视图。",
    contentFontLabel: "内容 / 代码字体",
    contentFontOptionFollowUi: "跟随界面字体",
    contentFontOptionSystemMono: "系统等宽",
    effectiveAppearance: "当前界面外观：{{theme}} · 界面：{{uiFont}} · 内容：{{contentFont}} · {{size}}px",
    ...
    fontDescription: "选择用于导航、列表和表单的界面字体。如果当前设备没有安装对应字体，AIProxy 会自动回退到相近字体。",
    fontLabel: "界面字体",
    ...
    fontSizeDescription: "字号会立即作用于整个桌面工作台，并保存在当前设备上。",
    fontSizeLabel: "字体大小",
    languageDescription: "选择 AIProxy 跟随系统语言，或者固定使用某一种界面语言。",
    languageLabel: "显示语言",
    ...
    themeDescription: "选择 AIProxy 跟随系统外观，或者固定使用浅色或暗黑主题。",
    themeLabel: "界面主题",
    themeOptionDark: "暗黑",
    themeOptionLight: "浅色",
