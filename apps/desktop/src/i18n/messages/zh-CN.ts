...
export const zhCNMessages: Messages = {
  ...
  certificatesPage: {
    ...
    mobile: {
      ...
      adbInstallBody: "连接一台 Android 设备并开启 USB 调试后，点击按钮即可。Pharles 会把根证书推送到设备的 Downloads 目录，并在设备上拉起系统证书安装界面。",
      adbInstallHint: "这不是静默安装，你仍需要在手机上确认并完成安装。",
      ...
      adbSuccessBody: "证书已复制到 {{deviceSerial}} 的 {{remotePath}}。请在手机上完成后续安装流程。",
      adbSuccessTitle: "已打开 ADB 安装器",
      android: "Android",
