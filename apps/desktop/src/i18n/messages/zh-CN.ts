...
export const zhCNMessages: Messages = {
  ...
  appShell: {
    ...
    viewLogsAction: "查看日志",
    windowsMenu: {
      adbClearProxy: "通过 ADB 清除代理",
      adbSetProxy: "通过 ADB 设置代理",
      androidQuickActions: "Android 快捷操作",
      breakpointRules: "断点规则...",
      certStatus: "证书状态",
      ...
      cut: "剪切",
      darkTheme: "深色主题",
      documentation: "AIProxy 文档",
      edit: "编辑",
      exportHar: "导出为 HAR...",
      file: "文件",
      find: "查找...",
      harmonyQuickActions: "HarmonyOS 快捷操作",
      help: "帮助",
      importHar: "导入 HAR...",
      installCert: "安装根证书",
      iosQuickActions: "iOS 快捷操作",
      lightTheme: "浅色主题",
      maximize: "最大化",
      minimize: "最小化",
      paste: "粘贴",
  ...
  settingsPage: {
    ...
    notificationsSectionDescription: "在应用窗口外显示的系统级通知。",
    breakpointNotificationsLabel: "断点通知",
    breakpointNotificationsDescription:
      "当应用失焦时，断点命中会弹出系统通知；若系统权限被拒绝则静默回退。",
  ...
  rulesPage: {
    ...
    title: "规则",
    untitledRule: "未命名规则",
    unsavedChangesMessage: "规则编辑器中存在未保存的修改，离开后将丢失。",
  ...
  breakpointPanel: {
    ...
    countdownTooltip: "到达 0:00 后会自动放行且不做修改",
    copyBody: "复制 Body",
    emptyBody: "Body 为空",
    expandEditor: "展开编辑器",
    formMode: "表单",
    ...
    statusLabel: "状态码",
    drop: "丢弃",
    releasedToast: "已在超时后放行 {{method}} {{target}}。",
    notificationTitle: "有断点命中",
  ...
  websocket: {
    ...
    loadFailedTitle: "消息加载失败",
    loadFailed: "无法加载该连接的历史消息。",
    retry: "重试",
